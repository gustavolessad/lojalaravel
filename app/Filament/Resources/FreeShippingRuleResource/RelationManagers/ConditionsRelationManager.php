...
namespace App\Filament\Resources\FreeShippingRuleResource\RelationManagers;
    ...
    public function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Select::make('type')
                ...
                ->options([
                    'exclude_category' => '🚫 Excluir categoria — NÃO aplicar se o carrinho tiver produto desta categoria',
                    'exclude_product'  => '🚫 Excluir produto — NÃO aplicar se este produto estiver no carrinho',
                    'include_category' => '✅ Incluir categoria — Aplicar SOMENTE se tiver produto desta categoria',
                    'include_product'  => '✅ Incluir produto — Aplicar SOMENTE se este produto estiver no carrinho',
                ])
                ->required()
                ->live()
                ->columnSpanFull(),
            ...
            Forms\Components\Select::make('item_id')
                ->label(fn (Get $get) => str_contains((string) $get('type'), 'category')
                    ? 'Categoria'
                    : 'Produto')
